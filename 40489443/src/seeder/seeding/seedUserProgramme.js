export async function up(queryInterface) {
  const userProgrammes = [
    ...
    { user_id: 2, programme_id: 3, assigned_date: new Date('2021-09-01'), active: true },
    { user_id: 2, programme_id: 4, assigned_date: new Date('2021-09-01'), active: true },
    { user_id: 3, programme_id: 5, assigned_date: new Date('2023-01-01'), active: true },
    { user_id: 4, programme_id: 6, assigned_date: new Date('2023-01-01'), active: true },
  ];
